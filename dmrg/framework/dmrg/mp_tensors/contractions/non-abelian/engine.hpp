...
namespace contraction {
    ...
    public:
        ...
        {
            return common::overlap_left_step<Matrix, OtherMatrix, SymmGroup>
                   (bra_tensor, ket_tensor, left);
        }
        ...
        overlap_right_step(MPSTensor<Matrix, SymmGroup> const & bra_tensor,
                           ...
                           block_matrix<OtherMatrix, SymmGroup> * localop = NULL)
        {
            return common::overlap_right_step<Matrix, OtherMatrix, SymmGroup>
                   (bra_tensor, ket_tensor, right);
        }
