        ...
        for (std::size_t p = 0; p < L; ++p)
        {
            ...
            if (mpos_mix.size() == 0) {
                 ...
                 */
                {
                    ...
                    SiteProblem<Matrix, Matrix, SymmGroup> sp(mps_large[2*p], left_[2*p], right, mpos_mix[p+1][2*p]);
                 ...
                 */
                {
                    ...
                    SiteProblem<Matrix, Matrix, SymmGroup> sp(mps_large[2*p+1], left_[2*p+1], right, mpos_mix[p+1][2*p+1]);
