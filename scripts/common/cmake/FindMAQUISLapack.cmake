...
if(${BLAS_LAPACK_SELECTOR} MATCHES "mkl_sequential")
  ...
  set(MAQUISLapack_LIBRARIES "${MKLSTATIC} -lpthread -lm -ldl")
...
elseif(${BLAS_LAPACK_SELECTOR} MATCHES "mkl_parallel")
  ...
  set(MKL $ENV{MKLROOT}/lib/intel64)
  set(MKLSTATIC_INTEL  "-Wl,--start-group ${MKL}/libmkl_intel_lp64.a ${MKL}/libmkl_core.a ${MKL}/libmkl_intel_thread.a -Wl,--end-group")
  set(MKLSTATIC_GCC  "-Wl,--start-group ${MKL}/libmkl_intel_lp64.a ${MKL}/libmkl_core.a ${MKL}/libmkl_gnu_thread.a -Wl,--end-group")
  ...
  if(${CMAKE_CXX_COMPILER_ID} STREQUAL "Intel")
    ...
    set(MAQUISLapack_LIBRARIES "${MKLSTATIC_INTEL} -liomp5 -lpthread -lm -ldl -qopenmp")
  else()
    #set(MAQUISLapack_LIBRARIES "-lmkl_intel_lp64 -lmkl_core -lmkl_gnu_thread -ldl -lpthread -lm -fopenmp")
    set(MAQUISLapack_LIBRARIES "${MKLSTATIC_GCC} -ldl -lpthread -lm -fopenmp")
  endif()
  set(MAQUISLapack_INCLUDE_DIRS $ENV{MKLROOT}/include)
